...
public class OtpVerifyDemo {
     ...
     */
    private static String SECRET_ID = "402708e9c7892efc7c5552597d6eb19a";
    private static String SECRET_KEY = "dff47a9f0a838a2fa278dea0ef92d362";
...
// }
     ...
     * 发送验证码短信：指明由易盾生成验证码
     */
    public static SendResponse sendOtp() {
        // 这是你的 国内验证码短信 业务的ID。可以登录易盾官网查看此业务ID。
        String businessId = "cf27cb1315814806b588471293ec403f";
        // 这是你事先创建好的模板，且已通过审核。
        String templateId = "15554";
        // 这是收信方号码。如，134开头的号码一般是中国移动的号码。
        String to = "15267224153";
